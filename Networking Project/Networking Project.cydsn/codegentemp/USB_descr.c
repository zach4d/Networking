...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USB_DEVICE0_CONFIGURATION0_DESCR[25u] = {
...
*********************************************************************/
const T_USB_EP_SETTINGS_BLOCK CYCODE USB_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[1u] = {
...
const T_USB_LUT CYCODE USB_DEVICE0_CONFIGURATION0_TABLE[4u] = {
    ...
    {0x01u,     &USB_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
