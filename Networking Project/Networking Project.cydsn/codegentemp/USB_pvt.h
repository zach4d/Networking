...
extern const uint8 CYCODE USB_DEVICE0_CONFIGURATION0_DESCR[25u];
extern const T_USB_EP_SETTINGS_BLOCK CYCODE USB_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[1u];
