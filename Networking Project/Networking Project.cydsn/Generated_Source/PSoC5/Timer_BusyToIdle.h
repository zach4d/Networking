...
#if !defined(CY_Timer_v2_60_Timer_BusyToIdle_H)
#define CY_Timer_v2_60_Timer_BusyToIdle_H
...
#if defined(Timer_BusyToIdle_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG)
    #define Timer_BusyToIdle_UDB_CONTROL_REG_REMOVED            (0u)
#elif  (Timer_BusyToIdle_UsingFixedFunction)
    #define Timer_BusyToIdle_UDB_CONTROL_REG_REMOVED            (0u)
#else 
    #define Timer_BusyToIdle_UDB_CONTROL_REG_REMOVED            (1u)
#endif /* End Timer_BusyToIdle_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG */
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer_BusyToIdle_COUNTER_LSB_PTR_8BIT       ((reg8 *) Timer_BusyToIdle_TimerUDB_sT16_timerdp_u0__A0_REG )
